...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <table class="formview">
        ...
        <tr>
            <th>No.PO</th>
            <td><input type="text" id="cari_nopo" size="20" value="%"/></td>
        </tr>
        <tr>
            <th>Pelanggan</th>
    ...
    <div id="mdl">
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    <th>Kategori</th>
                    <td><select id="mdl_ctgsales" disabled></select></td>
                </tr>
                <tr>
                    <th>Broker</th>
                ...
                <tr>
                    <th>No.PO</th>
                    <td><label id="mdl_invoice_nopo"></label></td>
                </tr>
                <tr style="background-color:gray;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" Runat="Server">
    <script type="text/javascript">
        var cari = {
            ...
            tb_nopo: apl.func.get("cari_nopo"),
            ...
            load: function () {
                ...
                var nopo = escape(cari.tb_nopo.value);
                ...
                cari.fl.src = "opr_sales_list.aspx?no=" + no + "&cust=" + cust + "&status=" + status + "&fs=" + fs + "&branch=" + cari.dl_branch.value + "&ssm=" + ssm + "&displayadd=0&nopo=" + nopo;
            },
            fl_refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                lb_invoice_nopo: apl.func.get("mdl_invoice_nopo"),
