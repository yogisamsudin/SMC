            ...
            var mdl_device = apl.createModal("mdl_device",
                {
                    ...
                    val02: apl.createValidator("device_save", "mdl_device_name", function () { return apl.func.emptyValueCheck(mdl_device.tb_cost.value); }, "Salah input"),
                    ...
                    val04: apl.createValidator("device_save", "mdl_device_name", function () { return apl.func.emptyValueCheck(mdl_device.tb_price.value); }, "Salah input"),
                    ...
                    edit: function (sales_id, device_id) {
                        ...
                        activities.opr_sales_device_data(sales_id, device_id,
                            function (data) {
                                ...
                                //if ('<%= user_id %>' != 'sa' && mdl.lb_invoice_no.innerHTML != "")
                                /*
                                {
