        ...
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    ...
                    <td>
                        <table id="mdl_tbl" class="gridView">
                            <tr>
                                <th style="width:25px">
                                    <%--<div class="tambah" onclick="mdl.tambah_device()"></div>--%>
                                </th>
                                <th>Device</th>
                                <th>Modal</th>
                                <th>HPP</th>
                ...
                <tr>
                    ...
                    <td><input type="text" id="mdl_addicost" size="15" style="text-align:right;" disabled="disabled"/></td>
                </tr>   
                <tr>
                    <th>Net</th>
                ...
                <tr>
                    ...
                    <td style="border-top:2px solid gray;"><input type="text" id="mdl_total_price" size="15" style="text-align:right;" disabled="disabled"/></td>
                </tr>                
                <tr style="display:none;">
                    <th>PPH 21 -</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" Runat="Server">
    <script type="text/javascript">
        var cari = {
            ...
            //dl_status: apl.createDropdownWS("cari_status", activities.dl_opr_status_sales_list1),
            ...
            load: function () {
                ...
                var status = "3";//escape(cari.dl_status.value);
                var fs = "%";//cari.dl_finance_sts.value;
                var ssm = "%";//escape(cari.dl_marketing_sts.value);
                cari.fl.src = "opr_sales_list.aspx?no=" + no + "&cust=" + cust + "&status=" + status + "&fs=" + fs + "&branch=%&ssm=" + ssm + "&displayadd=0&nopo=%";
            },
            fl_refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                tb_addicost: apl.createNumeric("mdl_addicost", true),
                ...
                edit: function (id, show_sts) {
                    ...
                    activities.opr_sales_data(id,
                        function (data) {
                            ...
                            mdl.tb_addicost.setValue(data.additional_cost);
            ...
            function () {
                if (apl.func.validatorCheck("save")) {
                    ...
                    activities.opr_sales_edit(mdl.sales_id, mdl.tb_date.value, mdl.dl_broker.value, mdl.dl_discount_type.value, mdl.tb_discount_value.getIntValue(), mdl.cb_tax.checked, mdl.tb_fee.getIntValue(), mdl.tb_note.value, mdl.dl_status.value, mdl.tb_addfee.getIntValue(), mdl.tb_addfeenote.value, '<%= user_id %>',
                        function () {
                ...
                var mdladdicost = apl.createModal("mdladdicost",
                    {
                        ...
                        edit: function (id) {
                            ...
                            activities.opr_sales_addicost_data(id, function (data) {
                    ...
                    function () {
                        ...
                        {
                            activities.opr_sales_addicost_add(mdl.sales_id, mdladdicost.tb_name.value, mdladdicost.tb_nilai.getIntValue(),
                                function () {
                                    mdladdicost.hide();
                    ...
                    function () {
                        if (apl.func.validatorCheck("addicostupdate")) {
                            activities.opr_sales_addicost_edit(mdladdicost.addicost_id, mdladdicost.tb_name.value, mdladdicost.tb_nilai.getIntValue(),
                                function () {
                                    mdladdicost.hide();
                    ...
                    function () {
                        ...
                        {
                            activities.opr_sales_addicost_delete(mdladdicost.addicost_id,
                                function () {
                                    mdladdicost.hide();
                                    mdl.edit(mdl.sales_id);
                                }, apl.func.showError, "");
