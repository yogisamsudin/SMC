...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <div id="mdl">
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    <th>Note</th>
                    <td><textarea id="mdl_note" disabled></textarea></td>
                </tr>
                <tr>
    ...
    <div id="mdl_device">
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    <th>Biaya Service</th>
                    <td><input type="text" size="20" id="mdl_device_cost" style="text-align:right;" disabled/></td>
                </tr>
                <tr>
                    <th>Biaya Cancel</th>
                    <td><input type="text" size="20" id="mdl_device_cancel" style="text-align:right;" disabled/></td>
                </tr>
                <tr>
    ...
    <div id="mdl_component">
        <fieldset>
            ...
            <table class="formview">
                <tr>
                    <th>Device</th>
                    <td><input id="mdl_component_device" disabled/></td>
                </tr>
                <tr>
                    <th>Cost</th>
                    <td><input type="text" id="mdl_component_cost" size="15" maxlength="15" style="text-align:right;" disabled/></td>
                </tr>
                <tr>
                    <th>Total#1</th>
                    <td><input type="text" id="mdl_component_total1" size="3" maxlength="3" style="text-align:right;" disabled/></td>
                </tr>
                <tr>
                    <th>Harga</th>
                    <td>
                        <input type="text" id="mdl_component_price" size="15" maxlength="15" style="text-align:right;float:left;" disabled/>
                ...
                <tr>
                    <th>Total#2</th>
                    <td><input type="text" id="mdl_component_total2" size="3" maxlength="3" style="text-align:right;" disabled/></td>
                </tr>
                <tr style="display:none;">
                    <th>PPH 21</th>
                    <td><input type="checkbox" id="mdl_component_pph21" disabled/></td>
                </tr>
            </table>
            <div style="padding-top:5px;" class="button_panel">
                <%--<input type="button" value="Add"/>
    ...
    <div class="modal" id="mdladdicost">
        <fieldset>
            <legend></legend>
            <table class="formview">
                <tr>
                    <th>Keterangan</th>
                    <td><input type="text" size="50" maxlength="100" id="mdladdicost_name"/></td>
                </tr>
                <tr>
                    <th>Nilai</th>
                    <td><input type="text" size="12" maxlength="12" id="mdladdicost_value" style="text-align:right;"/></td>
                </tr>
            </table>
            <div style="padding-top:5px;" class="button_panel">
                <input type="button" value="Add"/>
    ...
    <script type="text/javascript">
        var cari = {
            ...
            load: function () {
                ...
                var status = "3";//window.escape(cari.dl_status.value);
                ...
                cari.fl.src = "opr_service_list.aspx?no=" + no + "&cust=" + cust + "&status=" + status + "&finance_sts=" + finance_sts + "&sn=" + sn + "&ts=" + ts + "&branch=" + branch + "&ssm=" + ssm + "&displayadd=0";
            },
            fl_refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                open_document: function () {
                    if (mdl.event_sts == false) {
                        activities.opr_service_document_data(mdl.service_id,
                            function (data) {
                                if (data.service_id == 0) alert("Tidak ada file document");
                                else {
        ...
        var mdladdicost = apl.createModal("mdladdicost",
            {
                addicost_id: 0,
                tb_name: apl.func.get("mdladdicost_name"),
                tb_nilai: apl.createNumeric("mdladdicost_value", true),

                val1: apl.createValidator("addicostupdate", "mdladdicost_name", function () { return apl.func.emptyValueCheck(mdladdicost.tb_name.value); }, "Invalid input"),
                val2: apl.createValidator("addicostupdate", "mdladdicost_value", function () { return apl.func.emptyValueCheck(mdladdicost.tb_nilai.value); }, "Invalid input"),

                kosongkan: function () {
                    mdladdicost.addicost_id = 0;
                    mdladdicost.tb_name.value = "";
                    mdladdicost.tb_nilai.value = "";
                    apl.func.hideSinkMessage();
                    apl.func.validatorClear("addicostupdate");
                },
                tambah: function () {
                    mdladdicost.kosongkan();
                    mdladdicost.showAdd("Tambah Data");
                },
                edit: function (id) {
                    mdladdicost.kosongkan();
                    activities.opr_service_addicost_data(id,
                        function (data) {
                            mdladdicost.addicost_id = data.addicost_id;
                            mdladdicost.tb_name.value = data.addicost_name;
                            mdladdicost.tb_nilai.setValue(data.addicost_value);
                            mdladdicost.showEdit("Edit Data");
                        }, apl.func.showError, ""
                    );
            ...
            function () {
                if (apl.func.validatorCheck("addicostupdate")) {
                    activities.opr_service_addicost_add(mdl.service_id, mdladdicost.tb_name.value, mdladdicost.tb_nilai.getIntValue(),
                                function () {
                                    mdladdicost.hide();
                                    mdl.edit(mdl.service_id);
                                }, apl.func.showError, ""
                            );
                }
            },
            function () {
                if (apl.func.validatorCheck("addicostupdate")) {
                    activities.opr_service_addicost_edit(mdladdicost.addicost_id, mdladdicost.tb_name.value, mdladdicost.tb_nilai.getIntValue(),
                                function () {
                                    mdladdicost.hide();
                                    mdl.edit(mdl.service_id);
                                }, apl.func.showError, ""
            ...
            function () {
                if (confirm("Yakin dihapus?")) {
                    activities.opr_service_addicost_delete(mdladdicost.addicost_id,
                        function () {
                            mdladdicost.hide();
                            mdl.edit(mdl.service_id);
                        },
