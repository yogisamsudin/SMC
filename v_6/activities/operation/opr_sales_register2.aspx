    ...
    <div id="mdl_device">
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    <th>Sts.Garansi</th>
                    <td><input type="checkbox" id="mdl_guaranteests"/></td>
                </tr>
                <tr>
                    <th>Ketersediaan Brg.</th>
                    <td><select id="mdl_availability"></select></td>
                </tr>
                <tr>
                    <th>Draft</th>
    ...
    <script type="text/javascript">
        var cari = {
            ...
            load: function () {
                ...
                var fs = "0";
                var ssm = "%";
                cari.fl.src = "opr_sales_list.aspx?allow=0&no=" + no + "&cust=" + cust + "&status=" + status + "&fs=" + fs + "&branch=" + cari.dl_branch.value + "&ssm=" + ssm + "&displayadd=0&nopo=%";
            },
            fl_refresh: function () {
