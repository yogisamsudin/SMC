    ...
    <script type="text/javascript">
        ...
        var cari = {
            ...
            load: function () {
                ...
                var fs = "0";
                var ssm = "%";
                cari.fl.src = "opr_sales_list.aspx?allow=0&no=" + no + "&cust=" + cust + "&status=" + status + "&fs=" + fs + "&branch=" + cari.dl_branch.value + "&ssm=" + ssm + "&displayadd=0&nopo=%&followup=1&complete=1";
            },
            fl_refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                dl_status: apl.createDropdownWS("mdl_status", activities.dl_opr_status_sales_list2, undefined, undefined, undefined, function () { return " type='oprsalessts' and code in ('1','2')"; }),
