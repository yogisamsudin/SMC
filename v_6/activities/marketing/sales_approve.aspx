...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <table class="formview">
        ...
        <tr>
            <th>Pelanggan</th>
            <td>
                <input type="text" id="cari_customer" size="50" value="%" /></td>
        </tr>
        <tr>
            <th>Cabang</th>
            <td>
        ...
        <fieldset>
            ...
            <table class="formview">
                <tr>
                    <th>Tanggal</th>
                    <td>
                        <label id="mdl_date"></label>
                    </td>
                </tr>
                <tr>
                    <th>Nama Pelanggan </th>
                    <td>
                        <input type="text" id="mdl_customer" disabled="disabled"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="mdl_branch" size="50" maxlength="50" disabled="disabled"/></td>
                </tr>
                <tr>
                    <th>Atas Nama</th>
                    <td>
                        <select id="mdl_an" disabled="disabled"></select></td>
                </tr>
                <tr>
                    <th>Kontak</th>
                    <td>
                        <select id="mdl_contact" disabled="disabled"></select></td>
                </tr>
                <tr>
                    <th>Alamat Kurir #1</th>
                    <td>
                        <input type="text" id="mdl_pickup_address" disabled="disabled"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="mdl_pickup_address2" size="100" maxlength="300" disabled="disabled"/></td>
                </tr>
                <tr>
                    <th>Catatan</th>
                    <td>
                        <textarea id="mdl_note" style="max-width: 100%; width: 600px; height: 200px; font-family: 'Courier New';" disabled="disabled"></textarea></td>
                </tr>
                <tr>
                    <th>Tgl.Kurir</th>
                    <td>
                        <input type="text" id="mdl_pickup_date" size="10" maxlength="10" disabled="disabled"/></td>
                </tr>
                <tr>
                    <th>Fee</th>
                    <td>
                        <input type="text" id="mdl_fee" style="text-align: right;" disabled="disabled"/></td>
                </tr>
                <tr>
                    <th colspan="2" style="background-color: gray; text-align: center;">
                        <div class="refresh" style="float: left;" onclick="mdl.load_opr_data();"></div>
                        Operation
                    </th>
                </tr>
                <tr>
                ...
                <tr>
                    <th>Broker</th>
                    <td>
                        <label id="mdl_broker"></label>
                    </td>
                </tr>
                <tr>
                    <th>Pajak</th>
                    <td>
                        <input type="checkbox" id="mdl_tax" disabled /></td>
                </tr>
                <tr>
                    <th>Device</th>
                    <td>
                ...
                <tr>
                    <th>Total Modal</th>
                    <td>
                        <input type="text" disabled="disabled" style="text-align: right;" size="20" id="mdl_principal" /></td>
                </tr>
                <tr>
                    <th>Total Pofit</th>
                    <td>
                        <input type="text" disabled="disabled" style="text-align: right;" size="20" id="mdl_principalnet" /></td>
                </tr>
                <tr>
                    <th>Nilai Invoice</th>
                    <td>
                        <input type="text" disabled="disabled" style="text-align: right;" size="20" id="mdl_total" /></td>
                </tr>
                <tr>
                    <th>Note</th>
                    <td>
                        <textarea id="mdl_oprnote" disabled="disabled"></textarea></td>
                </tr>
                <tr style="display:none">
                    <th>Respon</th>
                    <td>
                        <select id="mdl_marketing_status"></select></td>
                </tr>
                <tr style="display:none">
                    <th>Alasan</th>
                ...
                <tr>
                    <th>File PO</th>
                    <td>
                        <label for="mdl_fu" style="font-weight:bold;cursor:pointer;display:none;">Upload</label > 
                        | 
                        ...
                        <input type="file" id="mdl_fu" style="display:none;"/>
                    </td>
                </tr>
                <tr>
                    <th>File Penawaran</th>
                    <td>| <label style="font-weight:bold;cursor:pointer;" onclick="mdl.print_offer();">Open</label></td>
                </tr>
            ...
            <div style="padding-top: 5px;" class="button_panel">
                ...
                <input type="button" value="Approve" onclick="mdl.approve_offer()" />
        ...
        <fieldset>
            ...
            <table class="formview">
                <tr>
                    <th>Lokasi</th>
                    <td>
                        <input type="text" id="mdl_addlocation_location" autocomplete="off" size="50" /></td>
                </tr>
            </table>
        ...
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    <th>Keterangan</th>
                    <td>
                        <textarea id="mdl_device_description" readonly="readonly"></textarea></td>
                </tr>
                <tr>
                    <th>Marketing Note</th>
                    <td>
                        <textarea id="mdl_device_note"></textarea></td>
                </tr>
                <tr>
                    <th>Pokok Jual</th>
                    <td>
                        <input type="text" id="mdl_device_principal_price" disabled="disabled" style="text-align: right;" size="15" /></td>
                </tr>
                <tr>
                    <th>Harga</th>
                    <td>
                        ...
                        <div class="select" style="float: left;" onclick="mdl_device.tbl_load()">
                            ...
                            <div style="height: 200px; overflow: scroll; width: 700px;" class="gridView">
                                <table id="mdl_device_tbl_price">
                                    <tr>
                                        <th style="width: 25px;">
                                            <input type="checkbox" id="mdl_device_all_customer" title="Cek semua pelanggan" checked="checked" /></th>
                                        <th>Customer</th>
                                        <th>Tgl.Penawaran</th>
                                        <th>Harga</th>
                                    </tr>
    ...
    <script type="text/javascript">
        ...
        var cari = {
            ...
            load: function () {
                ...
                cari.fl.src = "sales_approve_list.aspx?no=" + no + "&user=" + user + "&cust=" + cust + "&branchid=" + escape(branch_id);
            },
            fl_refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                */
                ...
                fl_fu: apl.create_selectfile("mdl_fu", function (e) {
                    mdl.event_sts = true;
                    apl.func.showSinkMessage("Simpan...");
                    apl.func.read_file_readAsArrayBuffer(mdl.fl_fu.get_file(),
                        function (filedata) {
                            activities.opr_sales_document_save(mdl.sales_id, mdl.fl_fu.get_info().name, filedata, mdl.fl_fu.get_info().type, function () { apl.func.hideSinkMessage(); mdl.event_sts = false;}, apl.func.showError, "");
                        }
                    );
                }),
                ...
                approve_offer:function()
                {
                    if(confirm("Yakin akan di approve?"))
                    {
                        apl.func.showSinkMessage("Menyimpan...");
                        activities.opr_sales_edit_approve(mdl.sales_id, s_user_id,
                            function () {
                                mdl.hide();
                                cari.fl_refresh();
                                apl.func.hideSinkMessage();
            ...
            function () {
                if (apl.func.validatorCheck("save")) {
                    ...
                    activities.opr_sales_edit_marketing(mdl.sales_id, mdl.dl_marketing_status.value, mdl.ddl_reason.value, '<%= user_id %>', function () { mdl.hide(); apl.func.hideSinkMessage(); }, apl.func.showError, "");
                    //if (mdl.fl_fu.check_file()) activities.opr_sales_document_save(mdl.sales_id, mdl.fl_fu.get_info().name, mdl.fl_fu.get_array(), mdl.fl_fu.get_info().type, function () { mdl.hide(); apl.func.hideSinkMessage(); }, apl.func.showError, ""); else apl.func.hideSinkMessage();
                    //ddalert(mdl.fl_fu.get_array());
                    //alert(mdl.fl_fu.get_info().name);
                    //activities.opr_sales_document_save(mdl.sales_id, mdl.fl_fu.get_info().name, mdl.fl_fu.get_array(), function () { }, apl.func.showError, "");
                }
