    ...
    <script type="text/javascript">
        var cari = {
            ...
            load: function () {
                ...
                cari.fl.src = "mkt_sales_list.aspx?no=" + no + "&cust=" + cust + "&status=" + status + "&fs=" + fs + "&branch=" + cari.dl_branch.value + "&ssm=" + ssm + "&displayadd=0&marketing_id=<%= user_id %>";
            },
            fl_refresh: function () {
                ...
                edit: function (id, show_sts) {
                    ...
                    activities.opr_sales_data(id,
                        function (data) {
                            ...
                            mdl.tb_total_cost.setValue(data.total_principal);
