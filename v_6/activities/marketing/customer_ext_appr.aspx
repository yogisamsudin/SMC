...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <table class="formview">
        <tr>
            <th>Pelanggan</th>
            <td><input type="text" id="cari_customer" value="%"/></td>            
        </tr>
        <tr>
            <th></th>
        ...
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    ...
                    <td><input type="text" id="mdl_group_customer" disabled="disabled"/></td>
                </tr>
                ...
                <tr>
                    <th>Cabang</th>
                    <td><select id="mdl_branch" disabled="disabled"></select></td>
                </tr>
                <tr>
                    <th>Kontak</th>
                    <td>
                ...
                <tr>
                    <th>Approve</th>
                    <td><input type="checkbox" id="mdl_approve"/></td>
                </tr>
            </table>
    ...
    <script type="text/javascript">
        ...
        fl.fl = {
            ...
            load: function () {
                ...
                fl.src = "customer_ext_appr_list.aspx?status=0&name="+name;
            },
            refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                cb_approve:apl.func.get("mdl_approve"),
            ...
            undefined,
            function () {
                if (apl.func.validatorCheck("save") && mdl.cb_approve.checked==true) {
                    activities.act_customer_ext_approve(mdl.customer_id, mdl.dl_marketing.value, mdl.refresh, apl.func.showError, "");
                } else {
                    alert("Checked in status first");
                }
            },
            function () {
                if (confirm("Yakin akan dihapus?")) {
                    activities.act_customer_delete_ext(mdl.customer_id, mdl.refresh, apl.func.showError, "");
                }
