    ...
    <div id="mdl" class="modal">
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    <th>Garansi</th>
                    <td><label id="mdl_guarantee"></label></td>
                </tr>
                <tr>
                    <th style="width:200px">Tgl.Onsite</th>
                    <td><input type="text" id="mdl_onsitedate" size="10" disabled/> sampai <input type="text" id="mdl_onsitedate2" size="10" disabled/></td>
                </tr>
                <tr>
                    <th>Teknisi</th>
                    <td><input type="text" id="mdl_technician" size="50" disabled/></td>
                </tr>
                <tr>
                ...
                <%--<tr>
                    <th>Selesai</th>
                    <td><input type="checkbox" id="mdl_donests" disabled/></td>
                </tr>--%>
    ...
    <div id="mdlodr">
        <fieldset>
            ...
            <table class="formview">
                <tr>
                    <th>Sts.Device</th>
                    <td><select id="mdlodr_stsdevice" disabled></select></td>
                </tr>
                <tr>
                    <th>Tgl.Segel</th>
                    <td><input type="text" id="mdlodr_tglsegel" size="10" disabled/></td>
                </tr>
                <tr>
                    <th>Tgl.Garansi</th>
                    <td><input type="text" id="mdlodr_tglgaransi" size="10" disabled/></td>
                </tr>
                <tr>
                    <th>Unit</th>
                    <td><input type="text" id="mdlodr_unit" disabled/></td>
                </tr>
                <tr>
                    <th>SN</th>
                    <td><input type="text" id="mdlodr_sn" disabled/></td>
                </tr>
                <tr>
                    <th>Complaint</th>
                    <td><textarea id="mdlodr_complaint" disabled></textarea></td>
                </tr>
                <tr>
                    <th>Note</th>
                    <td><textarea id="mdlodr_note" disabled></textarea></td>
                </tr>
                <tr>
    ...
    <div id="mdlpart">
        <fieldset>
            ...
            <table class="formview">
                <tr>
                    <th>Part</th>
                    <td><input type="text" id="mdlpart_part" disabled/></td>
                </tr>
                <tr>
                    <th>Total</th>
                    <td><input type="text" id="mdlpart_total" style="text-align:right;" disabled/></td>
                </tr>
            </table>
            <div style="padding-top:5px;" class="button_panel">
                <input type="button" value="Close"/>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" Runat="Server">
    <script type="text/javascript">
        var cari = {
            ...
            dl_status: apl.createDropdownWS("cari_status", activities.dl_onsitests, undefined, undefined, undefined, function () { return " type='onsitests'"; }),
            load: function () {
                var custname = escape(cari.tb_customer.value);
                var no = escape(cari.tb_no.value);
                var status = cari.dl_status.value;
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                lb_guarantee: apl.func.get("mdl_guarantee"),
                ...
                edit:function(id, addsts)
                {
                    ...
                    activities.tec_onsite_data(id,
                        function (data) {
                            ...
                            mdl.lb_guarantee.innerHTML = data.guarantee_onsite_name;
                            mdl.guarantee_sts = data.guarantee_sts;
                            mdl.lb_status.innerHTML = data.onsitests;
        ...
        var mdlodr = apl.createModal("mdlodr",
            ...
            function () {
                ...
                {
                    activities.tec_onsite_workorders_add(mdl.onsite_id, mdlodr.ac_unit.id, mdlodr.tb_sn.value, mdlodr.tb_note.value, mdlodr.tb_complaint.value,mdlodr.dl_stsdevice.value,mdlodr.tb_tglsegel.value,mdlodr.refresh,apl.func.showError, "");
                }
            },
            function () {
                if (apl.func.validatorCheck("odrsave")) {
                    activities.tec_onsite_workorders_edit(mdlodr.workorder_id, mdlodr.ac_unit.id, mdlodr.tb_sn.value, mdlodr.tb_note.value, mdlodr.tb_complaint.value, mdlodr.dl_stsdevice.value, mdlodr.tb_tglsegel.value, mdlodr.refresh, apl.func.showError, "");
                }
            }, 
            function () {
        ...
        var mdlpart = apl.createModal("mdlpart",
            {
                ...
                val2: apl.createValidator("partsave", "mdlpart_total", function () { return apl.func.emptyValueCheck(mdlpart.tb_total.text); }, "Invalid input"),
