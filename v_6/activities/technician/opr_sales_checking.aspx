...
<script runat="server">
    public string application_date, user_id, opr_sales_edit, style_print;
    ...
    <script type="text/javascript">
        var cari = {
            ...
            load: function () {
                ...
                var fs = "0";
                var ssm = "%";
                cari.fl.src = "../operation/opr_sales_stscheck_list.aspx?no=" + no + "&cust=" + cust + "&status=" + status + "&fs=" + fs + "&branch=" + cari.dl_branch.value + "&nopo=%&ssm=" + ssm + "&displayadd=1";
            },
            fl_refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                dl_status: apl.createDropdownWS("mdl_status", activities.dl_opr_status_sales_list2, undefined, undefined, undefined, function () { return " type='oprsalessts' and code in ('7','6','3')"; }),
                    ...
                    activities.opr_sales_document_data(mdl.sales_id,
                        function (data) {
                            if (data.sales_id == 0) alert("Tidak ada file document");
                                ...
                                mdl.ln_url.click();
                                if (saveconfirm) if (confirm("Pernjualan sesuai dengan PO?")) mdl.save_data();
                                //alert("seting");
                            }
            ...
            function () {
                if (apl.func.validatorCheck("save")) {
                    if (mdl.dl_status.value == "3") mdl.open_document(true); else mdl.save_data();
