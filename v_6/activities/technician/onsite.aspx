        ...
        <fieldset>
            ...
            <table class="formview">
                ...
                <tr>
                    ...
                    <td><input type="text" id="mdl_onsitedate" size="10"/> sampai <input type="text" id="mdl_onsitedate2" size="10"/></td>
                </tr>
                <tr>
                    <th>Teknisi</th>
    ...
    <script type="text/javascript">
        var cari = {
            ...
            load: function () {
                ...
                var status = '3';
                cari.fl.src = "onsite_list.aspx?custname=" + custname + "&no=" + no + "&status=" + status;
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                dl_status: apl.createDropdownWS("mdl_status", activities.dl_onsitests, undefined, undefined, undefined, function () {return " type='onsitests' and code in ('3','4','5')" }),
            ...
            function () {
                ...
                {
                    activities.tec_onsite_edit2(mdl.onsite_id, mdl.tb_note.value, mdl.tb_onsitedate.value, mdl.tb_onsitedate.value, mdl.tb_technician.value, mdl.dl_status.value,
                        function () {
                            mdl.hide();
                            cari.fl_refresh();
                        },
